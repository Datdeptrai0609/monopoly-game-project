...
class Board {
  ...
  //private TravelBlock[] travelList; //travelList contain all TraveBlock to makeTravel()
  private Wini ini;
  ...
  public Board() throws IOException {
    ...
    //travelList = new TravelBlock[castNum(ini.get("travel", "size"))];
  ...
  //private void makeTravel() {
    ...
    //for (TravelBlock travelBl : travelList) {
      //travelBl.createGroup(travelList);
    //}
  //}
  ...
  // int cost = 60;
  // int houses = 50;
  // return new PropertyBlock("Pleiku", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 60;
  // int houses = 50;
  // return new PropertyBlock("Ninh Binh", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 60;
  // int houses = 50;
  // return new PropertyBlock("Lang Son", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 60;
  // int houses = 50;
  // return new PropertyBlock("Ca Mau", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 60;
  // int houses = 50;
  // return new PropertyBlock("Da Lat", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 100;
  // int houses = 50;
  // return new PropertyBlock("Thai Binh", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 100;
  // int houses = 50;
  // return new PropertyBlock("Thanh Hoa", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 120;
  // int houses = 50;
  // return new PropertyBlock("Hai Phong", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 140;
  // int houses = 100;
  // return new PropertyBlock("Ninh Thuan", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 140;
  // int houses = 100;
  // return new PropertyBlock("Tay Ninh", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 160;
  // int houses = 100;
  // return new PropertyBlock("Hue", pos, rent, oneH, twoH, threeH, fourH, hotel,
  // cost, houses);
  // }
  ...
  // int cost = 200;
  // int houses = 100;
  // return new PropertyBlock("Sapa", pos, rent, oneH, twoH, threeH, fourH, hotel,
  // cost, houses);
  // }
  ...
  // int cost = 220;
  // int houses = 150;
  // return new PropertyBlock("Hoi An", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 220;
  // int houses = 150;
  // return new PropertyBlock("Da Nang", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 260;
  // int houses = 150;
  // return new PropertyBlock("Binh Duong", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 260;
  // int houses = 150;
  // return new PropertyBlock("Can Tho", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 280;
  // int houses = 150;
  // return new PropertyBlock("Sai Gon", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
  ...
  // int cost = 300;
  // int houses = 200;
  // return new PropertyBlock("Ha Noi", pos, rent, oneH, twoH, threeH, fourH,
  // hotel, cost, houses);
  // }
